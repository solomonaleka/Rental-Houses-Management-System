...
echo '<td><a href="rent.php?booking_id='.$row['booking_id'].'"> <b> PAY RENT </b> </a> </td>';
echo "</tr>";
echo "</tbody>";
}
echo "</table>";
...
echo "<h4 style=\"color:blue;margin-left:50px;\">"."Ensure you have rented out a house and cleared the Deposit"."</h4>".mysqli_connect_error();
}
