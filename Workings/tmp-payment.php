...
if($final_payment<$amount) {
    ...
    do {
        $sql="insert into rent (firstname,secondname,phonenumber,house_id,amount,paid,arrears) values ('$firstname','$secondname','$phonenumber','$houseid','$amount','$new_over_payment','$new_arrears')";
        $result=mysqli_query($db_conn,$sql);
        $new_over_payment-=$amount;

    }   while ($new_over_payment>0);
...
//obtaining overpayment
    ...
    do {
        $sql="insert into rent (firstname,secondname,phonenumber,house_id,amount,paid,arrears) values ('$firstname','$secondname','$phonenumber','$houseid','$amount','$over_payment','$arrears')";
        $result=mysqli_query($db_conn,$sql);
        $over_payment-=$amount;

    } while ($over_payment>0);
