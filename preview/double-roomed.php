            ...
            <div class="card mb-4 wow fadeIn">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                    ...
                    <h4 class="mb-2 mb-sm-0 pt-1">
                        <a href="double-roomed.php">Home Page</a>
                        <span>/</span>
                        <span>Double Roomed Houses</span>
                    </h4>
...
inner join `destination` ON houses.destination_id = destination.destination_id and houses.house_type='Double roomed houses' and houses.status='Available')";
...
echo "<h4 style=\"color:black;margin-left:50px;\">"."Currently there are no vacant double roomed houses!!"."</h4>".mysqli_connect_error();
}
}
