            ...
            <div class="card mb-4 wow fadeIn">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                    ...
                    <h4 class="mb-2 mb-sm-0 pt-1">
                        <a href="detached.php">Home Page</a>
                        <span>/</span>
                        <span>Detached Houses</span>
                    </h4>
...
inner join `destination` ON houses.destination_id = destination.destination_id and houses.house_type='Detached Houses' and houses.status='Available')";
...
echo "<h4 style=\"color:black;margin-left:50px;\">"."Currently there are no vacant Standalone Houses!!"."</h4>".mysqli_connect_error();
}
}
