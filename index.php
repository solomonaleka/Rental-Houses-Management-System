...
$sql="SELECT houses.house_type,houses.amount,houses.status,houses.detail,houses.image,houses.house_number,houses.house_position,building.building_name,destination.destination_name FROM  ((`houses` inner join `building` ON houses.building_id = building.building_id)
inner join `destination` ON houses.destination_id = destination.destination_id and houses.status='Available')";
...
while($row=mysqli_fetch_array($result)) {
    ...
    echo '<!--Card content-->';
        ...
        echo '<a class="btn btn-unique" href="booking.php">'.'Rent Out'.'</a>';
        echo '</div>';*/
