            ...
            <div class="card mb-4 wow fadeIn">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                    ...
                    <h4 class="mb-2 mb-sm-0 pt-1">
                        <a href="landlords.php">Admin</a>
                        <span>/</span>
                        <span>View List of Landlords</span>
                    </h4>
...
echo "<h4 style=\"color:black;margin-left:50px;\">"."There are currently no landlords!!"."</h4>".mysqli_connect_error();
}
}
...
<div class="text-center mt-4">
        <a class="btn btn-unique" href="new-landlord.php">Add Landlord</a>
</div>
